...
# Title: Wifi Loopback
# Generated: Sun Nov  1 13:43:54 2015
##################################################
...
def main(top_block_cls=wifi_loopback, options=None):
    ...
    tb = top_block_cls(chan_est=options.chan_est, encoding=options.encoding, freq_offset=options.freq_offset, interval=options.interval, pdu_length=options.pdu_length, snr=options.snr)
    tb.start()
    try:
